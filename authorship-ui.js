...
const detail=`<div class="jf-auth-box"><strong>${CREDIT}</strong><p>Concepção, direção do produto, arquitetura da experiência, curadoria de conteúdo, testes, validação e evolução: ${AUTHOR}.</p><a href="${LINK}" target="_blank" rel="noopener">Ver declaração completa de autoria</a></div>`;
