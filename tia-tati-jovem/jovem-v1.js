(()=>{
'use strict';
if(window.__TIA_TATI_JOVEM_V4__)return;
window.__TIA_TATI_JOVEM_V4__=true;
...
function apply(){
 document.documentElement.classList.add('tia-jovem-v4');
 isolateHome();
 ensureSixCards();
 buildHero();
 tuneCards();
...
function start(){
 apply();
 [80,220,500,900,1600,2600].forEach(t=>setTimeout(apply,t));
