...
const cards=[
  {sel:'[data-youth-light="react"]',art:'assets/jovem-v27/reflexo-neon.webp?v=58',title:'Reflexo Neon',desc:'Resposta rápida • atenção • alcance',badge:'REAÇÃO'},
  {sel:'[data-youth-light="memory"]',art:'assets/jovem-v27/memorize.webp?v=58',title:'Memorize',desc:'Sequência visual • memória de trabalho',badge:'MEMORIZE'},
  {sel:'[data-youth-light="beat"]',art:'assets/jovem-v27/ritmo-movimento.webp?v=58',title:'Ritmo e Movimento',desc:'Ritmo • coordenação • tempo de resposta',badge:'RITMO'},
  {sel:'[data-youth-sensory]',art:'assets/jovem-v27/laboratorio-pulso.webp?v=58',title:'Laboratório do Pulso',desc:'Exploração • foco • causa e efeito',badge:'LABORATÓRIO DO PULSO'},
  {sel:'[data-jlab="ping-focus"]',art:'assets/jovem-v27/pingpong-approved-v54.webp?v=58',title:'Ping Pong Focus',desc:'Reflexo • precisão • controle motor',badge:'PING PONG FOCUS'},
  {sel:'[data-jlab="piano-lab"]',art:'assets/jovem-v27/piano-lab.svg?v=58',title:'Piano Lab',desc:'Iniciação musical • ouvido • coordenação',badge:'PIANO LAB'},
  {sel:'[data-youth-breathe]',art:'assets/jovem-v27/recomeco.webp?v=58',title:'Recomeço',desc:'Pausa • foco • respiração guiada',badge:'RECOMEÇO'},
  {sel:'[data-youth-physical]',art:'assets/jovem-v27/missao-movimento.webp?v=58',title:'Missão Movimento',desc:'Movimento real • sequência • etapas',badge:'MISSÃO MOVIMENTO'}
];
const HERO='assets/jovem-v27/hero-jovem.webp?v=58';
