...
const safe={react:'assets/cards/reflexo-neon.webp?v=24',memory:'assets/cards/memorize.webp?v=24',beat:'assets/cards/beat-move.webp?v=24'};
function fallback(){
...
fallback();
const script=document.createElement('script');script.src='jovem-illustrated-v24.js?v=24&t='+Date.now();script.async=true;script.onerror=fallback;document.body.appendChild(script);
