...
#screen-home .ping50-art{position:relative!important;display:block!important;width:100%!important;aspect-ratio:2.88/1!important;overflow:hidden!important;background:#07132f!important}
...
#screen-home .ping50-image:after{content:"";position:absolute;inset:0;border:1px solid rgba(69,233,255,.36);box-shadow:inset 0 0 28px rgba(255,79,168,.18);pointer-events:none}
#screen-home .ping50-badge{position:absolute;left:9px;top:7px;z-index:3;color:#fff;font-size:.46rem;font-style:normal;font-weight:950;letter-spacing:.08em;text-shadow:0 2px 7px rgba(0,0,0,.9)}
