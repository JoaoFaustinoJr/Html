const CACHE='maker-quest-v2-20260904';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./rai-icon.svg','./icon-192.png','./icon-512.png','./maker-quest-share.jpg'];
