const CACHE='maker-quest-v1-20260904';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./rai-icon.svg','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
