...
;(()=>{if(window.__TIA_TATI_CLASSIC_FORCE_LOADER__)return;window.__TIA_TATI_CLASSIC_FORCE_LOADER__=true;const s=document.createElement('script');s.src='tangram-classic-v1.js?v=20260921-modelos-enviados';s.async=true;document.head.appendChild(s)})();
