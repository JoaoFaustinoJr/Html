(()=>{
'use strict';
if(window.__TIA_TATI_KIDS_CARDS_UI_V16__)return;
window.__TIA_TATI_KIDS_CARDS_UI_V16__=true;
const CARDS=[
...
function artMarkup(c){if(c.image)return `<span class="tati-card-art"><img class="tati-sprite-img" src="${c.image}?v=16" alt="${c.title}" decoding="async" loading="eager" draggable="false" style="width:100%;height:100%;object-fit:cover;object-position:center"></span>`;const shift=c.side?'-50%':'0%';return `<span class="tati-card-art"><img class="tati-sprite-img" src="${c.sprite}?v=8" alt="${c.title}" decoding="async" loading="eager" draggable="false" style="--tati-shift:${shift}"></span>`;}
