(()=>{
'use strict';
if(window.__TIA_TATI_MAGIC_MIRROR_PORTAL_LINK_V34__)return;
window.__TIA_TATI_MAGIC_MIRROR_PORTAL_LINK_V34__=true;
const $=(s,r=document)=>r.querySelector(s);
function installStyle(){
 if($('#mmCardV34Style'))return;
 const s=document.createElement('style');s.id='mmCardV34Style';s.textContent=`
