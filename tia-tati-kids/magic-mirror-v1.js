(()=>{
'use strict';
if(window.__TIA_TATI_MAGIC_MIRROR_PORTAL_LINK_V16__)return;
window.__TIA_TATI_MAGIC_MIRROR_PORTAL_LINK_V16__=true;
const $=(s,r=document)=>r.querySelector(s);
function installStyle(){
 if($('#mmCardV16Style'))return;
 const s=document.createElement('style');s.id='mmCardV16Style';s.textContent=`
