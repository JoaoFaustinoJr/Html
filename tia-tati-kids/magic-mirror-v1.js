(()=>{
'use strict';
if(window.__TIA_TATI_MAGIC_MIRROR_PORTAL_LINK_V29__)return;
window.__TIA_TATI_MAGIC_MIRROR_PORTAL_LINK_V29__=true;
const $=(s,r=document)=>r.querySelector(s);
function installStyle(){
 if($('#mmCardV29Style'))return;
 const s=document.createElement('style');s.id='mmCardV29Style';s.textContent=`
