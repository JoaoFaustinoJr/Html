(()=>{
'use strict';
if(window.__TIA_TATI_MAGIC_MIRROR_PORTAL_LINK_V19__)return;
window.__TIA_TATI_MAGIC_MIRROR_PORTAL_LINK_V19__=true;
const $=(s,r=document)=>r.querySelector(s);
function installStyle(){
 if($('#mmCardV19Style'))return;
 const s=document.createElement('style');s.id='mmCardV19Style';s.textContent=`
