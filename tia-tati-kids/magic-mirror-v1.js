(()=>{
'use strict';
if(window.__TIA_TATI_MAGIC_MIRROR_PORTAL_LINK_V27__)return;
window.__TIA_TATI_MAGIC_MIRROR_PORTAL_LINK_V27__=true;
const $=(s,r=document)=>r.querySelector(s);
function installStyle(){
 if($('#mmCardV27Style'))return;
 const s=document.createElement('style');s.id='mmCardV27Style';s.textContent=`
