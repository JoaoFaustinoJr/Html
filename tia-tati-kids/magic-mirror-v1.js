(()=>{
'use strict';
if(window.__TIA_TATI_MAGIC_MIRROR_PORTAL_LINK_V20__)return;
window.__TIA_TATI_MAGIC_MIRROR_PORTAL_LINK_V20__=true;
const $=(s,r=document)=>r.querySelector(s);
function installStyle(){
 if($('#mmCardV20Style'))return;
 const s=document.createElement('style');s.id='mmCardV20Style';s.textContent=`
