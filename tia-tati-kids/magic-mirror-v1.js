(()=>{
'use strict';
if(window.__TIA_TATI_MAGIC_MIRROR_PORTAL_LINK_V21__)return;
window.__TIA_TATI_MAGIC_MIRROR_PORTAL_LINK_V21__=true;
const $=(s,r=document)=>r.querySelector(s);
function installStyle(){
 if($('#mmCardV21Style'))return;
 const s=document.createElement('style');s.id='mmCardV21Style';s.textContent=`
