(()=>{
'use strict';
if(window.__TIA_TATI_MAGIC_MIRROR_PORTAL_LINK_V28__)return;
window.__TIA_TATI_MAGIC_MIRROR_PORTAL_LINK_V28__=true;
const $=(s,r=document)=>r.querySelector(s);
function installStyle(){
 if($('#mmCardV28Style'))return;
 const s=document.createElement('style');s.id='mmCardV28Style';s.textContent=`
...
function install(){
 ...
 b.innerHTML=`<span class="home-v22-visual mm-card-art"><img src="../tia-tati-espelho/assets/mask-v6-2.webp?v=28" alt="Espelho Encantado da Tia Tati" decoding="async"><span class="mm-card-sparkles" aria-hidden="true">✦ ✨ ✦</span></span><span class="home-v22-mission-copy"><span class="home-v22-mission-icon">🪞</span><span><strong>Espelho Encantado</strong><small>Expressões • imitação • voz</small></span></span><span class="mm-card-meta" aria-hidden="true"><i>👧 Menina</i><i>👦 Menino</i><i>🎙️ Pergunte</i></span><em>Portal</em>`;
 b.addEventListener('click',()=>{location.href='../tia-tati-espelho/?from=kids&v=28&fresh='+Date.now()});g.appendChild(b);return true;
}
