...
function addCard(){const g=$('.home-v22-missions');if(!g)return false;let b=g.querySelector('[data-new-game="mosaic-wood"]');if(!b){b=document.createElement('button');g.appendChild(b)}b.type='button';b.className='home-v22-mission tt-new-game-card tt-mosaic-wood-card';b.dataset.newGame='mosaic-wood';b.innerHTML='<span class="home-v22-visual"><img src="assets/file_00000000985c820eada058626308697f.png?v=1" alt="Mosaico Kids da Tia Tati"></span><span class="home-v22-mission-copy"><span class="home-v22-mission-icon">🧩</span><span><strong>Mosaico da Tia Tati</strong><small>Montar • explorar • criar padrões</small></span></span><em>Nova missão</em>';b.onclick=open;return true}
