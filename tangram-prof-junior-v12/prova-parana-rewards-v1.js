(()=>{
  ...
  function readState(){
    try{
      ...
      return{...v,mastered:Array.isArray(v.mastered)?v.mastered:[]};
  ...
  function ensureCelebration(){
    ...
    celebration.innerHTML=`<div class="rai-bonus-card" role="dialog" aria-modal="true" aria-labelledby="raiBonusTitle">
      <button type="button" class="rai-bonus-close" aria-label="Fechar">×</button>
      <div class="rai-bonus-trophy">🎁</div>
      <small id="raiBonusEyebrow">MISSÃO DA RAÍ</small>
      <h3 id="raiBonusTitle">Desafio Bônus</h3>
      <p id="raiBonusText"></p>
      <div class="rai-bonus-actions"><button type="button" class="primary" data-play>▶ Jogar agora</button><button type="button" data-study>🎯 Ir para Prova Paraná</button><button type="button" data-close>Continuar</button></div>
    </div>`;
  ...
  function bonusButton(i){
    ...
    return buttons[BONUS_START+i]||null;
  }
  ...
  function ensureSection(){
    ...
    const n=count();
    section.innerHTML=`<span>🎯</span><div><b>Desafios Bônus</b><small>Prova Paraná • ${n}/4 liberados</small></div>`;
  }
