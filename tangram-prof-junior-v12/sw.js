const CACHE='tangram-rai-v12-56';
const ASSETS=['./index.html','./content-v12.json','./manifest.webmanifest','./v10.css','./comfort-v11.css','./focus-v11.css','./performance-v12.css','./app-v10.js','./comfort-v11.js','./performance-v12.js','./rai-tutor-v13.js','./rai-tutor-v13.css','./rai-icon.svg','./rai-aula-v17.js','./rai-aula-v14.css','./rai-aula-v16.css','./rai-aula-v17.css','./rai-fundamentos-v17.json','./rai-pensamento-v17.json','./rai-programacao-v17.json','./rai-matematica-v17.json','./rai-mundo-digital-v17.json','./prova-parana-v1.js','./prova-parana-v1.css','./prova-parana-6-v1.json','./prova-parana-7-v1.json','./prova-parana-8a-v1.json','./prova-parana-8b-v1.json','./prova-parana-8c-v1.json','./prova-parana-8d-v1.json','./prova-parana-9-v1.json','./prova-parana-professor-v1.json','./gamer-official-v1.js','./gamer-official-v1.css','./shared-ui-v14.css','./identity-v15.css','./update-manager-v14.js','./game-polish-v13.js','./game-polish-v13.css','./icon-192.png','./icon-512.webp','./apple-touch-icon.png','../tangram-prof-junior/rai-chalk.webp','../tangram-prof-junior/chunk01.txt','../tangram-prof-junior/chunk02-03.txt','../tangram-prof-junior/chunk04-05.txt','../tangram-prof-junior/chunk06-07.txt','../tangram-prof-junior/chunk08-09.txt'];
const LIVE_RE=/\/(app-v10\.js|comfort-v11\.js|performance-v12\.js|rai-tutor-v13\.js|rai-aula-v17\.js|prova-parana-v1\.js|gamer-official-v1\.js|update-manager-v14\.js|game-polish-v13\.js|v10\.css|comfort-v11\.css|focus-v11\.css|performance-v12\.css|rai-tutor-v13\.css|rai-aula-v14\.css|rai-aula-v16\.css|rai-aula-v17\.css|prova-parana-v1\.css|gamer-official-v1\.css|shared-ui-v14\.css|identity-v15\.css|game-polish-v13\.css|rai-icon\.svg|rai-fundamentos-v17\.json|rai-pensamento-v17\.json|rai-programacao-v17\.json|rai-matematica-v17\.json|rai-mundo-digital-v17\.json|prova-parana-(?:6|7|8a|8b|8c|8d|9|professor)-v1\.json|content-v12\.json|manifest\.webmanifest|icon-192\.png|icon-512\.webp|apple-touch-icon\.png)$/;
...
self.addEventListener('fetch',event=>{
 ...
 if(event.request.mode==='navigate'){
  event.respondWith(fetch(event.request,{cache:'no-store'}).then(resp=>{if(!resp||!resp.ok)throw new Error('navigation');const clone=resp.clone();caches.open(CACHE).then(c=>c.put('./index.html',clone)).catch(()=>{});return resp}).catch(()=>caches.match('./index.html')));
  return;
 }
