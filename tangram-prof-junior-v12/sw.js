const CACHE='tangram-rai-v12-17';
const ASSETS=['./','./index.html','./content-v12.json','./manifest.webmanifest','./v10.css','./comfort-v11.css','./focus-v11.css','./performance-v12.css','./app-v10.js','./comfort-v11.js','./performance-v12.js','./rai-aula-v13.js','./rai-aula-v13.css','./icon-192.png','./icon-512.png','./apple-touch-icon.png','../tangram-prof-junior/rai-chalk.webp','../tangram-prof-junior/chunk01.txt','../tangram-prof-junior/chunk02-03.txt','../tangram-prof-junior/chunk04-05.txt','../tangram-prof-junior/chunk06-07.txt','../tangram-prof-junior/chunk08-09.txt'];
...
self.addEventListener('fetch',event=>{
  ...
  const live=/\/(app-v10\.js|comfort-v11\.js|performance-v12\.js|rai-tutor-v13\.js|v10\.css|comfort-v11\.css|focus-v11\.css|performance-v12\.css|rai-tutor-v13\.css|rai-aula-v13\.js|rai-aula-v13\.css|content-v12\.json|manifest\.webmanifest|icon-192\.png|icon-512\.png|apple-touch-icon\.png)$/.test(u.pathname);
  if(live){
