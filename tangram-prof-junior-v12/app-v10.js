(()=>{
  ...
  let deferredPrompt=window.__raiDeferredInstall||null, aboutInstall=null, installHelp=null;
  ...
  if(aboutBtn){
    ...
    const doInstall=async()=>{
      deferredPrompt=deferredPrompt||window.__raiDeferredInstall||null;
      ...
      if(isDesktop){
        showHelp(isWindows?'<b>Instalar no Windows:</b> o navegador ainda não liberou a janela automática. No <b>Microsoft Edge</b>, use <b>⋯ → Aplicativos → Instalar este site como um aplicativo</b>. No <b>Chrome</b>, use o ícone de instalação na barra de endereços ou <b>⋮ → Instalar Tangram Educativo</b>. Depois ele abrirá em janela própria e poderá aparecer no Menu Iniciar.':'<b>Instalar no Linux:</b> abra o Tangram no Chrome, Chromium ou Edge e use o ícone de instalação na barra de endereços ou o menu <b>⋮ → Instalar Tangram Educativo</b>. O app abrirá em janela própria.');
        return;
      }
