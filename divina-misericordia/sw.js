...
self.addEventListener('fetch',e=>{
 ...
 const fresh=u.pathname.endsWith('/index.html')||u.pathname.endsWith('/styles-v2.css')||u.pathname.endsWith('/music.js')||u.pathname.endsWith('/portal-v12.js')||u.pathname.endsWith('/sw.js');
