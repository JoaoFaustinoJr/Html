const CACHE='tia-tati-v58-direct-screen-20260910';
const CORE=[
 ...
 './activity-v54.html','./activity-v56.html','./activity-v57.html','./activity-v58.html','./activity.html','./styles.css?v=58',
 './app-base-v39.js?v=58','./sensory-v40.js?v=58','./remaining-v41.js?v=58','./naming-v42.js?v=58','./final-v44.js?v=58','./identity-v45.js?v=58',
...
self.addEventListener('fetch',event=>{
 ...
 if(event.request.mode==='navigate'){
  // Compatibilidade para homes antigas que ainda apontem para activity.html?open=...
  if(url.pathname.endsWith('/activity.html')&&url.searchParams.has('open')){
   const open=url.searchParams.get('open')||'road';
   event.respondWith(fetch('./activity-v58.html?open='+encodeURIComponent(open)+'&sw=58&t='+Date.now(),{cache:'no-store'}).catch(()=>caches.match('./activity-v58.html')));
   return;
  }
  event.respondWith(fetch(event.request,{cache:'no-store'}).catch(async()=>{
   if(url.pathname.endsWith('/activity-v58.html'))return(await caches.match('./activity-v58.html'))||Response.error();
   if(url.pathname.endsWith('/activity-v57.html'))return(await caches.match('./activity-v57.html'))||Response.error();
 ...
 const fresh=/\/(home-v54\.js|activity-v58\.html|activity-v57\.html|activity-v56\.html|activity-v54\.html|styles\.css|app-base-v39\.js|sensory-v40\.(?:js|css)|remaining-v41\.(?:js|css)|naming-v42\.js|polish-v43\.css|final-v44\.(?:js|css)|identity-v45\.(?:js|css)|assets\/cards\/(?:reflexo-neon|memorize|beat-move)\.webp)$/.test(url.pathname);
