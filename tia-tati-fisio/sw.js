...
self.addEventListener('fetch',event=>{
 ...
 const fresh=/\/(home-v54\.js|activity-v57\.html|activity-v56\.html|activity-v54\.html|app\.js|direct-route-v57\.js|styles\.css|app-base-v39\.js|sensory-v40\.(?:js|css)|remaining-v41\.(?:js|css)|naming-v42\.js|polish-v43\.css|final-v44\.(?:js|css)|identity-v45\.(?:js|css)|assets\/cards\/(?:reflexo-neon|memorize|beat-move)\.webp)$/.test(url.pathname);
