const CACHE='tia-tati-v54-direct-route-20260910a';
const CORE=[
 './index.html','./home-v51.css?v=54','./home-v51-polish.css?v=54','./home-v53.css?v=54','./home-v53-linkfix.css?v=54','./home-v54.css?v=54','./home-v54.js?v=54','./manifest.webmanifest?v=54',
 './activity-v54.html','./activity.html','./styles.css?v=54','./app.js?v=54','./direct-route-v54.js?v=54',
...
self.addEventListener('fetch',event=>{
 ...
 const fresh=/\/(home-v51(?:-polish)?\.css|home-v53(?:-linkfix)?\.css|home-v54\.(?:css|js)|activity-v54\.html|app\.js|direct-route-v54\.js|styles\.css|app-base-v39\.js|sensory-v40\.(?:js|css)|remaining-v41\.(?:js|css)|naming-v42\.js|polish-v43\.css|final-v44\.(?:js|css)|identity-v45\.(?:js|css)|assets\/cards\/(?:reflexo-neon|memorize|beat-move)\.webp)$/.test(url.pathname);
 if(fresh){
