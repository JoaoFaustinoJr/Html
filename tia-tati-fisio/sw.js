const CACHE='tia-tati-v53-shell-20260910b';
const CORE=[
 ...
 './assets/tati-approved-avatar.webp','./assets/tati-approved-hero.webp','./assets/tati-approved-hero-v52.b64',
...
self.addEventListener('fetch',event=>{
 ...
 const fresh=/\/(home-v51(?:-polish)?\.css|home-v53\.js|activity-v52\.html|app\.js|activity-router-v52\.js|styles\.css|app-base-v39\.js|sensory-v40\.(?:js|css)|remaining-v41\.(?:js|css)|naming-v42\.js|polish-v43\.css|final-v44\.(?:js|css)|identity-v45\.(?:js|css)|tati-approved-(?:avatar|hero)\.webp|tati-approved-hero-v52\.b64)$/.test(url.pathname);
